...
namespace NFe.Utils.Enderecos
{
    public static class Enderecador
    {
        ...
        {
            return new List<Estado> { Estado.CE, Estado.AC, Estado.AL, Estado.AP, Estado.DF, Estado.ES, Estado.MG, Estado.PB, Estado.RJ, Estado.RN, Estado.RO, Estado.RR, Estado.RS, Estado.SC, Estado.SE, Estado.SP, Estado.TO };
        }
