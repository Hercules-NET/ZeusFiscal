using NFe.Danfe.AppTeste.FastSkia;

Console.WriteLine("Hello, World!");

Console.WriteLine(@"Digite o caminho do .xml (ex: C:\arquivos\35199227357619000192550010090001111381546999.xml):");
string caminho = "C:\\Users\\danil\\Downloads\\31190520868582000130550010000289101000015001-nfe.xml";
...
while (true)
{
    try
    {
        var report = DanfeFrNfeHelper.GeraClasseDanfeFrNFe(xml);
        var data = report.Relatorio.GetDataSource("NFe.NFe.infNFe.transp.vol");
        data.Init();
        report.ExportarPdf(@"C:\\temp\\nfe.pdf");
